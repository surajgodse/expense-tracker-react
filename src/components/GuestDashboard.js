...
import { fetchGuestData } from './Firebase';
import { Container, Typography, Grid, Card, CardContent, Box, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
...
function GuestDashboard() {
  ...
  return (
    <Container className="dashboard-container">
      <Typography variant="h4" gutterBottom>Demo Dashboard</Typography>
      <Typography variant="subtitle1" gutterBottom>
        This is a view-only demo of the Expense Tracker dashboard. Sign up to create your own!
      </Typography>
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Card>
            <CardContent>
              <Typography variant="h5">Total Expenses: ${totalExpenses.toFixed(2)}</Typography>
            </CardContent>
          </Card>
        </Grid>
